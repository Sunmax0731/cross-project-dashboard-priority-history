# cross-project-dashboard-priority-history

横断プロジェクト優先度履歴ダッシュボード は、複数プロジェクトの優先度、状態、更新履歴を横断して確認する。
...
```powershell
cd D:\AI\ProjectManagement\cross-project-dashboard-priority-history
npm test
