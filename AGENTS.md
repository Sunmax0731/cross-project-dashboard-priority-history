...
このリポジトリは 横断プロジェクト優先度履歴ダッシュボード のMVP後改善版です。作業前に README.md、SKILL.md、docs/competitive-benchmark.md、docs/evaluation-criteria.md、docs/manual-test.md を確認してください。
